...
module "nightscout" {
  source             = "./nightscout/"
  security_groups    = [module.security_groups.allow-https, module.security_groups.allow-ssh] # Add "module.security_groups.allow-ssh" if you'd like to be able to access the instance via SSH
