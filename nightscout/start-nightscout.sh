...
aws ec2 modify-instance-credit-specification --instance-credit-specifications InstanceId=$INSTANCE_ID,CpuCredits=unlimited --region ${AWS_DEFAULT_REGION} --no-cli-pager
...
aws ec2 modify-instance-credit-specification --instance-credit-specifications InstanceId=$INSTANCE_ID,CpuCredits=standard --region ${AWS_DEFAULT_REGION} --no-cli-pager
